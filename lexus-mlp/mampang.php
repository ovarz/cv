...
<div class="rancak-container">
  ...
  <div class="rancak-form-box">
    ...
    <div aria-label="Plate No Request" aria-choice="Yes" class="rancak-form-input rancak-form-yesno" style="top:39.5vw; left:64.7vw;">
      ...
      <div aria-label="Plate No 1" class="rancak-form-input" style="width:28vw; height:2vw; top:43.4vw; left:65.8vw;">
        B 14 RIN
      </div>
      <div aria-label="Plate No 2" class="rancak-form-input" style="width:28vw; height:2vw; top:45.4vw; left:65.8vw;">
        D 1616 IT
      </div>
    ...
    <div aria-label="Car Type" class="rancak-form-input rancak-form-cartype" style="width:26vw; height:2vw; top:58.9vw; left:19.2vw;">
	  <div class="rancak-form-cartype-name">UX 250h F SPORT</div>
	  <div class="rancak-form-cartype-total">000</div>
	</div>
	
    <div aria-label="Exterior Color" class="rancak-form-input" style="width:28vw; height:2vw; top:60.9vw; left:19.2vw;">
	  Silver Metallic
	</div>
	
    <div aria-label="Interior Color" class="rancak-form-input" style="width:28vw; height:2vw; top:63.0vw; left:19.2vw;">
	  Black Carbon
	</div>
    ...
    <div aria-label="Frame No." class="rancak-form-input" style="width:36vw; top:84.8vw; left:11.8vw;">xxxx-xxxx-xxxx-xxxx</div>
	
    <div aria-label="Engine No." class="rancak-form-input" style="width:36vw; top:87.5vw; left:11.8vw;">xxxx-xxxx-xxxx-xxxx</div>
    ...
    <div aria-label="OTR Price" class="rancak-form-input" style="width:24.5vw; height:7.5vw; top:64.4vw; left:68.2vw; line-height:1.8vw;">IDR 000.000.000.000</div>
	
    <div aria-label="Special Appreciation" class="rancak-form-input" style="width:24.5vw; height:1.9vw; top:73vw; left:68.2vw; line-height:1.8vw;">IDR 000.000.000</div>
