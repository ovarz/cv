...
<div class="model-menu-list">
  <?php foreach($model_menu_array as $model_menu_list){ ?>
	<a title="<?php echo($model_menu_list['model_menu_name'])?>" class="mml-link" href="<?php echo $path; ?>/#<?php echo($model_menu_list['model_menu_id'])?>">
	  <?php echo($model_menu_list['model_menu_name'])?>
	</a>
  <?php } ?>
</div>
<div class="model-menu-action">
  <a title="Price" class="mma-link content_center" href="<?php echo $path; ?>/price">Price</a>
  <a title="Contact Dealer" class="mma-link content_center" href="<?php echo $path; ?>/">Contact Dealer</a>
</div>
